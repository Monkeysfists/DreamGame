    ...
    public class TeddyIdleAnimation : Animation
    {
        ...
        public TeddyIdleAnimation(int chapter)
        {
            switch (chapter)
            {
                ...
                case 3: SpriteSheet = GameHandler.AssetHandler.GetSpriteSheet("chapter2/ch2_teddy_shaking@2"); break;
                case 5: SpriteSheet = GameHandler.AssetHandler.GetSpriteSheet("chapter3/ch3_teddy_idle"); break;
